...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2018 at 10:47 AM
...
CREATE TABLE IF NOT EXISTS `maison` (
  ...
  `nom` varchar(255) DEFAULT NULL,
  `compt_linky` varchar(255) DEFAULT NULL,
  ...
  UNIQUE KEY `compt_linky` (`compt_linky`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
ALTER TABLE `conso_appareil`
  ADD CONSTRAINT `fk_conso_appareil_appareil1` FOREIGN KEY (`appareil_appareil_id`) REFERENCES `equipement` (`appareil_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
